...
(function($) {
    ...
    function getAxis(plot, e, gesture, navigationState) {
        if (e.type === 'pinchstart') {
            var axisTouch4 = plot.getTouchedAxis(e.detail.touches[0].pageX, e.detail.touches[0].pageY);
            var axisTouch2 = plot.getTouchedAxis(e.detail.touches[1].pageX, e.detail.touches[1].pageY);

            if (axisTouch4.length === axisTouch2.length && axisTouch4.toString() === axisTouch2.toString()) {
                return axisTouch4;
            }
