...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Finds intersections of two paths
     ...
     o         x: (number) x coordinate of the point
     o         y: (number) y coordinate of the point
     o         t1: (number) t value for segment of path4
     o         t2: (number) t value for segment of path2
     o         segment1: (number) order number for segment of path4
     o         segment2: (number) order number for segment of path2
     o         bez1: (array) eight coordinates representing beziér curve for the segment of path4
     o         bez2: (array) eight coordinates representing beziér curve for the segment of path2
     o     }
     o ]
    \*/
    R.pathIntersection = function (path4, path2) {
        return interPathHelper(path4, path2);
    };
    R.pathIntersectionNumber = function (path4, path2) {
        return interPathHelper(path4, path2, 1);
    };
    function interPathHelper(path4, path2, justCount) {
        path4 = R._path2curve(path4);
        path2 = R._path2curve(path2);
        var x1, y1, x2, y2, x1m, y1m, x2m, y2m, bez1, bez2,
            res = justCount ? 0 : [];
        for (var i = 0, ii = path4.length; i < ii; i++) {
            var pi = path4[i];
            if (pi[0] == "M") {
                x1 = x1m = pi[1];
                y1 = y1m = pi[2];
    ...
    var pathDimensions = R.pathBBox = function (path) {
        ...
        path2curve = R._path2curve = cacher(function (path, path2) {
            ...
            var p = pathToAbsolute(path),
                ...
                fixM = function (path4, path2, a1, a2, i) {
                    if (path4 && path2 && path4[i][0] == "M" && path2[i][0] != "M") {
